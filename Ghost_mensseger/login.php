...
<div id ="cab_log">
        ...
        <div id = "d_esquerda_log" class ="d_cab_log"> 
                ...
                <button id = "voltar_log"><a href="http://localhost/Ghost_mensseger/index.php" class = "link-as-button_log"> Voltar </a> </button>

        </div>
       
        <div id = "d_central_log" class ="d_cab_log">
        <a href = "http://localhost/ghost_mensseger/"><h1 id = "h1_cab_log"> Ghost messages </h1> </a>
        </div>
